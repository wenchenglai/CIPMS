...
{
    class EligibilityCincinatti:EligibilityBase
    {
        public EligibilityCincinatti(FederationEnum fed) : base(fed)
        {
        }
        ...
        public override bool checkEligibility(string FJCID, out int StatusValue)
        {
            ...
            //dsFirstTimeCamper = oCA.getCamperAnswers(FJCID, "34", "34", "N");
            //DataRow drFTC;
            ...
            //        oCA.UpdateAmount(FJCID, 1250.00, 0, "");
            //        FirstTimeCamper = true;
            //    }
            //}

            ////**************************
            ////Not needed for Cincinnati - as per new requirements - 02/09
