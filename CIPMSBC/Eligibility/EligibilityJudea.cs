...
{
    class EligibilityJudea : EligibilityBase
    {
        public EligibilityJudea(FederationEnum fed)
            : base(fed)
        {
        }
        ...
        public override bool checkEligibility(string FJCID, out int StatusValue)
        {
            ...
            //    else
            //    {
            //        // Camper grade value must be between 2 - 11
            //        Grade = Convert.ToInt32(drGrade["Answer"]);
            //        if ((Grade > 1) && (Grade < 12))
            //        {
            //            StatusValue = Convert.ToInt32(StatusInfo.SystemEligible);
            ...
            ////According to A-035
            ////Young Judaea: day school campers are now eligible
            ///*
