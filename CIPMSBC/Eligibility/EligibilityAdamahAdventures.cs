...
{
    class EligibilityAdamahAdventures : EligibilityBase
    {
        public EligibilityAdamahAdventures(FederationEnum fed)
            : base(fed)
        {
        }
        ...
        //private void StatusBasedOnCamperTimeInCampWithOutCamp(string FJCID, out int StatusValue)
        //{
        //    CamperApplication oCA = new CamperApplication();
