<%@ Page AutoEventWireup="true" CodeFile="ProgramProfileInformationReport.aspx.cs" Inherits="Administration_ProgramProfileInformationReport" Language="C#" MasterPageFile="~/AdminMaster.master" Title="Program Profile Information Report" %>
...
function HandleOnCheckList()
{
    ...
    <table class="text" width="100%" cellpadding="0" cellspacing="0" style="border-right: red 0.5pt solid;
        ...
        <tr>
            <td align="center">
                <span style="font-size: 14px; font-weight: bold; font-family: Verdana">Program Profile Information Report</span>
            </td>
        </tr>
        <tr>
            <td style="height: 10px">
        ...
        <tr>
            <td style="height: 10px">
				<asp:Button ID="btnClear" runat="server" Text="Clear All Reports" onclick="btnClear_Click" />
				<asp:Label ID="lblMsg" ForeColor="Red" runat="server"></asp:Label>
				<a href="GeneratePPIReport.aspx">Download Reports Here</a>
            </td>
        </tr>                
        <tr>
            <td style="height: 10px">
            ...
            <td>
                <div id="divFederationSelection" runat="server">
                    <table class="text" width="100%" style="border-right: thin solid; border-top: thin solid;
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="btnGenerateReport2" runat="server" Text="Generate Report" CssClass="submitbtn" OnClick="BtnGenerateReportClick" />
                            </td>
                        </tr>                        
                        <tr>
                            <td>
