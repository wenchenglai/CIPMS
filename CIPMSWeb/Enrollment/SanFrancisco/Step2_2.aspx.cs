...
public partial class Step2_URJ_2 : System.Web.UI.Page
{
	...
	{
        if (PageUtility.RedirectToNL((int)FederationEnum.SanFrancisco, Session["isGrantAvailable"] != null, Master.isAdminUser))
        {
    ...
    void btnNext_Click(object sender, EventArgs e)
    {
        ...
        if (strFJCID != "" && strModifiedBy != "")
        {
            ...
            {
                var objEligibility = EligibilityFactory.GetEligibility(FederationEnum.SanFrancisco);
