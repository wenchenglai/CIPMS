    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            <tr>
                ...
                <td valign="top">
                    <asp:Label ID="Label5" runat="server" CssClass="QuestionText">Will this be the camper’s first-time attending a nonprofit Jewish overnight camp for 5 consecutive days or longer?</asp:Label><br />
