<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="AcadamyStep2_3.aspx.cs" Inherits="Step2_SportsAcadamy_3" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server" width="100%">
       <%-- <table width="100%" cellpadding="5" cellspacing="0">
            <tr>
                <td>
                    <p class="headertext">•	Section IV: Camp and Session Information</p>
                </td>
            </tr>
        </table>--%>
