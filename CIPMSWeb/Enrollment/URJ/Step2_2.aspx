    ...
    <table width="100%" cellpadding="5" cellspacing="0" border="0">
        <tbody class="QuestionText">
            <tr>
                ...
                <td valign="top">Will this be the camper’s first-time attending a nonprofit Jewish overnight camp for <asp:Label runat="server" ID="lblDays" Text="12"></asp:Label> consecutive days or longer?
                <div>
