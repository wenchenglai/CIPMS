<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="AcadamyStep2_2.aspx.cs" Inherits="Step2_SportsAcadamy_2" Title="Camper Enrollment Step 2" %>
<%@ MasterType VirtualPath="~/Common.master" %>
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    <table width="100%" cellpadding="5" cellspacing="0">
       <%-- <tr>
            <td>
                <asp:Label CssClass="headertext" runat="server">•	Section III:  Detailed Camper Information</asp:Label><br /><br />
            </td>
        </tr>--%>
    </table>
    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            <tr>
                ...
                <td valign="top">
                    <asp:Label ID="Label5" runat="server" CssClass="QuestionText">Will this be the camper’s first time attending a nonprofit Jewish overnight summer camp for 12 days or longer?</asp:Label><br />
            ...
            <tr>
                <td valign="top" width="5%"><asp:Label ID="Label6" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label14" runat="server" Text="4" CssClass="QuestionText"></asp:Label></td>
