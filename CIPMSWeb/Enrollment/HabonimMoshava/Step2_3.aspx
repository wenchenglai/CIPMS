<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="Step2_3.aspx.cs" Inherits="Step2_Habonim_3" Title="Camper Enrollment Step 2" %>
            ...
            <tr>
                ...
                <td valign="top"  colspan="2">
                    <asp:Panel ID="PnlQ10" runat="server" Width="100%">
                        <div id="daysNote" runat="server"><b><asp:Label ID="lblSessionDays" runat="server" ForeColor="Red" Text="In order to be eligible for an incentive grant, the camper must attend camp for at least 12 consecutive days. If camper attended camp in the summer of 2014 for 12-18 days as a first time camper s/he is ONLY eligible for the grant if attending camp for 19 or more consecutive days in summer 2015." CssClass="QuestionText"></asp:Label></b><br /></div>
