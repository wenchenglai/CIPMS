...
<asp:Content ID="ContentStep2_MetroWest_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            ...
            <tr>
                <td valign="top" width="5%"><asp:Label ID="Label6" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label14" runat="server" Text="5" CssClass="QuestionText"></asp:Label></td>
    ...
    <asp:Panel ID="PnlHidden" runat="server">
       ...
       <%-- <asp:HiddenField ID="hdnQ4Id" runat="server" Value="36" />
        <asp:HiddenField ID="hdnQ5Id" runat="server" Value="37" />--%>
