<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true"
    CodeFile="Step2_3.aspx.cs" Inherits="Step2_JWest_3" Title="Camper Enrollment Step 2" %>
            ...
            <tr>
                <td>
                    <asp:CustomValidator ID="CusVal" CssClass="InfoText" runat="server" Display="Dynamic"
                        ClientValidationFunction="VaildatePage3Step2_JWest"></asp:CustomValidator>
        ...
        <asp:Label ID="lblEligibility" runat="server" CssClass="InfoText2">
            ...
            <tr>
                <td valign="top" width="5%">
                    <asp:Label ID="Label1" Text="*" runat="server" CssClass="InfoText" />
                    <asp:Label ID="Label14" runat="server" Text="4" CssClass="QuestionText"></asp:Label></td>
                <td valign="top" colspan="2">
                    ...
                    <asp:RadioButtonList ID="RadioBtnQ6" runat="server" CssClass="mylist" RepeatDirection="Vertical">
                        ...
                        <%--<asp:ListItem Text="Yes, I have registered for camp and my acceptance has been confirmed"
                            Value="2"></asp:ListItem>
            ...
            <tr>
                <td valign="top">
                    ...
                    <asp:Label ID="Label18" runat="server" Text="5" CssClass="QuestionText"></asp:Label></td>
                <td valign="top" colspan="2">
                    <asp:Panel ID="PnlQ7" runat="server">
                        ...
                        <asp:DropDownList ID="ddlCamp" runat="server" CssClass="dropdown" AutoPostBack="true">
            ...
            <tr>
                <td valign="top">
                    ...
                    <asp:Label ID="Label22" runat="server" Text="6" CssClass="QuestionText"></asp:Label></td>
                <td valign="top" colspan="2">
                    ...
                    <asp:Panel ID="PnlNote" runat="server">
                        <asp:Label ID="lblNote" runat="server" CssClass="QuestionText">
                            <p style="text-align:justify" id="pNote" runat="server"> 
                                <font color="red">In order to be eligible for the incentive grant, the camper must attend camp for at least 12 consecutive days.</p></asp:Label>
                    </asp:Panel>
                </td>
            </tr>
            <tr>
                <td valign="top">
                    &nbsp;&nbsp;<asp:Label ID="Label25" runat="server" Text="7" CssClass="QuestionText"></asp:Label></td>
                <td valign="top" colspan="2">
