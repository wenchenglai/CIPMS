...
<asp:Content ID="JWest_summary" ContentPlaceHolderID="Content" runat="Server">
            ...
            <td colspan="3">
                <asp:Label ID="lbl" runat="server" CssClass="QuestionText">
                    <p style="text-align:justify">
                       ...
                       please visit our website (<a href="www.OneHappyCamper.org/FindaCamp" target="_blank">www.OneHappyCamper.org/FindaCamp</a>).
                    </p>
                    <p style="text-align:justify">
                        ...
                        or contact your camp or Federation directly.
                    </p>
                </asp:Label>
            </td>
        </tr>
    ...
    <table visible="false" id="tblDisable" runat="server" width="100%" cellpadding="5" cellspacing="0">
        <tr>
            ...
            <td colspan="2">
				<asp:Label ID="Label3" CssClass="SummaryHeading" runat="server">Welcome back JWest camper!</asp:Label>
                <asp:Label ID="Label5" CssClass="infotext3" runat="server">
					<p style="text-align:justify">
						...
						Please <asp:HyperLink ID="hyl" NavigateUrl="~/CamperHolding.aspx?fed=Jwest" runat="server" Text="click here"></asp:HyperLink> to enter your contact information. We will notify you as soon as the application becomes available.
					</p>
                </asp:Label>
            </td>
        </tr>
