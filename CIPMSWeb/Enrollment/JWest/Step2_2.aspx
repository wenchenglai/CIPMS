<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="Step2_2.aspx.cs" Inherits="Step2_JWest_2" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <table width="50%" cellpadding="0" cellspacing="0" style="text-align:center">
            <tr>
                <td>
                    <asp:CustomValidator ValidationGroup="OtherValidation" ID="CusVal" CssClass="InfoText" runat="server" Display="Dynamic"  ClientValidationFunction="ValidatePage2Step2_JWest"></asp:CustomValidator>                    
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            ...
            <tr>
                ...
                <td valign="top">
                    <asp:Label ID="Label5" runat="server" CssClass="QuestionText">Will this be the camper's first time attending a nonprofit <b><u>Jewish overnight summer camp</u></b>? (If you have only attended  winter camp  and/or family camp  in the past, you should answer yes )</asp:Label><br />
            ...
            <tr>
                ...
                <td valign="top">
                    <asp:Panel ID="PnlQ4" runat="server" Width="100%">
                        ...
                        <asp:RadioButtonList ID="RadioBtnQ4" runat="server" CssClass="QuestionText" RepeatDirection="Vertical">
                            <asp:ListItem Text="Yes, the camper received a JWest Campership Incentive grant last summer for the <b><u>second</u></b> time" Value="2"></asp:ListItem>
...
<%--            <tr>
                ...
                <td valign="top">
                    <asp:Panel ID="PnlQ5" runat="server" Enabled="false">
                        <asp:Label ID="lblQ5" runat="server" CssClass="QuestionText">How many days did you attend a camp without your family?</asp:Label><br />
                        <asp:Label ID="lblYear" runat="server" CssClass="QuestionText">Year</asp:Label>&nbsp;&nbsp;<asp:TextBox ID="txtYear" MaxLength="4" runat="server" CssClass="txtbox1"></asp:TextBox>&nbsp;&nbsp;
                        <asp:Label ID="lblDays" runat="server" CssClass="QuestionText">No of Days</asp:Label>&nbsp;&nbsp;<asp:TextBox ID="txtNoofDays" MaxLength="3" runat="server" CssClass="txtbox1"></asp:TextBox>
                    </asp:Panel>
                </td>
            </tr>--%>
