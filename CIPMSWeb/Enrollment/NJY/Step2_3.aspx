<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="Step2_3.aspx.cs" Inherits="Step2_NJY_3" Title="Camper Enrollment Step 2" %>
        ...
        <asp:Label ID="lblEligibility" runat="server" CssClass="InfoText2">
            ...
            <tr>
                ...
                <td valign="top" colspan="2">
                    <asp:Label ID="Label15" runat="server" CssClass="QuestionText">Has the camper registered for </asp:Label><asp:Label  ID="campName" runat="server" CssClass="QuestionText"></asp:Label> <asp:Label ID="Label10" runat="server" CssClass="QuestionText"> yet?</asp:Label><br />
            ...
            <tr>
                ...
                <td valign="top"  colspan="2">
                    <asp:Panel ID="PnlQ10" runat="server" Width="100%">
                        <div id="daysNote" runat="server"><asp:Label ID="lbl" runat="server" CssClass="QuestionText"><font color="red"><b>In order to be eligible for the incentive grant, camper must attend camp for at least 19 consecutive days.</b></font></asp:Label><br /></div>
