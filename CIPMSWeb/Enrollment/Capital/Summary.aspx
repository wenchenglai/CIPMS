            ...
            <td colspan="2">
                <asp:Label ID="lblLable" CssClass="infotext3" runat="server">
                    <p style="text-align:justify">
						...
						please contact our Camp Team at <a href="mailto:info@capitalcamps.org" target="_blank">info@capitalcamps.org</a> or 301-468-2267.
					</p>
                </asp:Label>
            </td>
        </tr>
			...
			<td colspan="2">
				<asp:Label ID="Label1" CssClass="infotext3" runat="server">
					<p style="text-align:justify">
						...
						for over 25 years. We are located just over one hour from both Washington and Baltimore. Capital Camps is for campers entering grades 3 through 10. 
			...
			<td colspan="2">
				<asp:Label ID="Label2" CssClass="infotext3" runat="server">
					<p style="text-align:justify">
						...
						arts and theatre building, ropes challenge course (with two challenge towers and zip lines), tennis, volleyball and basketball courts, two large 
						...
						and more), swimming, boating, archery, drama, arts & crafts, ceramics, Jewish environmental education, outdoor adventure programs, 
