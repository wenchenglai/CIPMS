            ...
            <td colspan="2">
                <asp:Label ID="lblInstructions" runat="server" CssClass="infotext3">
                    <br /><p style="text-align:justify"> 
                     <b><font color="red">You must register for Adamah Adventures to be eligible for the Incentive grant.</font></b> 
                    </p></asp:Label>
            </td>
        </tr>
        <tr>
          <td colspan="2"><asp:Label ID="Label1" CssClass="infotext3" runat="server">
                ...
                <b><font color="red">Visit <a href="http:\\www.adamahaventures.org" target="_blank">www.adamahaventures.org</a> to register now! Before you go, be sure to 
