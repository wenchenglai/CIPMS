    ...
    <table id="tblRegular" runat="server" width="100%" cellpadding="5" cellspacing="0" class="infotext3" style="text-align:justify">
        ...
        <tr>
			<td colspan="2">
			    ...
			    <p>
                    The One Happy Camper Grant program, sponsored by the Jewish Federation of Greater Phoenix and the Foundation for Jewish Camp, offers incentive grants of up to $1,000 to first-time campers.
			    </p>
...
The Jewish Federation of Greater Phoenix One Happy Camper program is now closed for summer 2017. For more information or to be put on the waitlist, please contact Jennifer Gale  at JGale@jewishphoenix.org.  To see if your camp sponsors the One Happy Camper program please click the ¡§next¡¨ button at the bottom of the screen.
