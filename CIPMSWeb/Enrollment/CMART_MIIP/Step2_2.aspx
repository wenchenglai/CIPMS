<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="Step2_2.aspx.cs" Inherits="Step2_CMART_2" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <table width="50%" cellpadding="0" cellspacing="0" align="center" border="0">
            <tr>
                <td>
                    <asp:CustomValidator ValidationGroup="OtherValidation" ID="CusVal" CssClass="InfoText" runat="server" Display="Dynamic" ClientValidationFunction="ValidatePage2Step2_CMARTMiiP"></asp:CustomValidator>
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            <tr>
                <td valign="top"><asp:Label ID="Label25" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label4" runat="server" Text="1" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
                    <asp:Label ID="Label5" runat="server" CssClass="QuestionText">Will this be the camper’s first time attending Jewish overnight summer camp for 19 days or longer?</asp:Label><br />
             ...
             <tr>
                <td valign="top"><asp:Label ID="Label17" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label13" runat="server" Text="2" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td valign="top"><asp:Label ID="Label18" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label35" runat="server" Text="3" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
                    <asp:Panel ID="PnlQ5" runat="server">
                        <asp:Label ID="Label14" runat="server" CssClass="QuestionText">Did the camper receive an incentive grant through the Midwest Interfaith Incentive Program last summer? </asp:Label><br />
            ...
            <tr>
                <td valign="top"><asp:Label ID="Label2" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label8" runat="server" Text="4" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td valign="top"><asp:Label ID="Label3" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label10" runat="server" Text="5" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td valign="top" width="5%"><asp:Label ID="lblAsteriskForQ6" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="lblNumberForQ6" runat="server" Text="6" CssClass="QuestionText"></asp:Label></td>
            ...
            <tr>
                <td valign="top"><asp:Label ID="Label6" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label7" runat="server" Text="7" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
                    <asp:Label ID="Label12" runat="server" CssClass="QuestionText">Is the camper from an interfaith family (i.e. one parent is Jewish and one is not)?</asp:Label><br />
                    &nbsp;<asp:RadioButton ID="rdbtnQ71" value="1" runat="server" GroupName="RadiobuttonQ7" Text="Yes" CssClass="QuestionText" />
                    <asp:RadioButton ID="rdbtnQ72" value="2" GroupName="RadiobuttonQ7" runat="server" Text="No" CssClass="QuestionText" />
                </td>
            </tr>
            <!-- Admin Panel-->
            <tr>
    ...
    <asp:HiddenField ID="hdnQ8Id" runat="server" Value="13" />
    <asp:HiddenField ID="hdnQ9Id" runat="server" Value="1024" />
    ...
    <asp:HiddenField ID="hdnQ7Id" runat="server" Value="1014" />
    </asp:Content>
