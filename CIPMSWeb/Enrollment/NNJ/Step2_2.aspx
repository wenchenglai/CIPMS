        ...
        <table width="50%" cellpadding="0" cellspacing="0" align="center" border="0">
            <tr>
                <td>
                    ...
                    <asp:CustomValidator ValidationGroup="OtherValidation" ID="CusVal" CssClass="InfoText" runat="server" Display="Dynamic" ClientValidationFunction="ValidatePage2Step2_NNJ"></asp:CustomValidator>
             ...
             <tr>
                <td valign="top">
                    <asp:Label ID="Label19" Text="*" runat="server" CssClass="InfoText" /><asp:Label
                        ID="Label23" runat="server" Text="3" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
