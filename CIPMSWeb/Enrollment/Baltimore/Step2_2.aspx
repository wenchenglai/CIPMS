<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true"
    CodeFile="Step2_2.aspx.cs" Inherits="Step2_Dallas_2" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_Dallas_1" ContentPlaceHolderID="Content" runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
            ...
            <tr>
                <td>
                    <asp:CustomValidator ValidationGroup="OtherValidation" ID="CusVal" CssClass="InfoText"
                        runat="server" Display="Dynamic" ClientValidationFunction="ValidatePage2Step2_Baltimore"></asp:CustomValidator>
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label3" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label6"
                ...
                <td valign="top">
                    <asp:Panel ID="PnlQ3" runat="server">
                        ...
                        <asp:RadioButtonList AutoPostBack="true" ID="RadioBtnQ3" runat="server" CssClass="QuestionText"
            ...
            <tr>
                ...
                <td valign="top">
                    <asp:Panel ID="PnlQ4" runat="server">
                        <asp:Label ID="Label13" runat="server" CssClass="QuestionText">Did the camper receive an incentive grant through THE ASSOCIATED: Jewish Community Federation of Baltimore’s Jewish Overnight Campership Program last summer?</asp:Label><br />
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label12" Text="*" runat="server" CssClass="InfoText" /><asp:Label
                        ID="Label8" runat="server" Text="4" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label19" Text="*" runat="server" CssClass="InfoText" /><asp:Label
                        ID="Label10" runat="server" Text="5" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
                    ...
                    <asp:RadioButtonList AutoPostBack="true" CssClass="QuestionText" ID="RadioBtnQ6"
                    ...
                    <asp:RequiredFieldValidator ID="reqval" ControlToValidate="RadioBtnQ6" runat="server"
            ...
            <asp:Panel ID="pnlCamperSchool" runat="server">
                <tr>
                    <td width="5%">
                        <asp:Label ID="lblAsterisk" Text="*" runat="server" CssClass="InfoText" /><asp:Label
                            ID="lblNumber8" runat="server" Text="6" CssClass="QuestionText"></asp:Label></td>
             ...
             <tr>
                <td valign="top">
                    <asp:Label ID="Label1" Text="*" runat="server" CssClass="InfoText" /><asp:Label
                        ID="Label23" runat="server" Text="7" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label25" Text="*" runat="server" CssClass="InfoText" /><asp:Label
                        ID="Label26" runat="server" Text="8" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
                    <asp:Panel ID="Panel1" runat="server">
                        <asp:Label ID="Label28" runat="server" CssClass="QuestionText">Is the camper enrolled in a religious school in Baltimore?</asp:Label><br />
                        <asp:RadioButtonList ID="RadioBtnQ10" runat="server" CssClass="QuestionText" RepeatDirection="Horizontal"
                            AutoPostBack="true">
                            <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                            <asp:ListItem Text="No" Value="2"></asp:ListItem>
                        </asp:RadioButtonList>
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label29" Text="*" runat="server" CssClass="InfoText" /><asp:Label
                        ID="Label30" runat="server" Text="9" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
                    <asp:Panel ID="Pnl11a" runat="server">
                        <asp:Label ID="Label31" runat="server" CssClass="QuestionText">Please select the synagogue with which the religious school is associated:</asp:Label><br />
                        <asp:DropDownList ID="ddlSynagogueQ11" runat="server" CssClass="dropdown" AutoPostBack="true">
                        </asp:DropDownList>
                    </asp:Panel>
                </td>
            </tr>
            <tr>
                <td valign="top">
                    <asp:Label ID="Label32" runat="server" Text="" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
                    <asp:Panel ID="Pnl11b" runat="server">
                        <asp:Label ID="lblOtherSynogogueQuesQ11" CssClass="QuestionText" runat="server" Enabled="false">Please enter the name of your synagogue:</asp:Label><br />
                        <asp:TextBox ID="txtOtherSynagogueQ11" runat="server" CssClass="txtbox" Enabled="false"
                ...
                <td valign="top" colspan="2">
                    <table width="100%" cellspacing="0" cellpadding="5" border="0">
                        <tr>
                            ...
                            <td align="left">
                                <asp:Button ID="btnNext" ValidationGroup="OtherValidation" Text="Next >>" CssClass="submitbtn"
                                    runat="server" />
                            </td>
                        </tr>
                    </table>
    ...
    <asp:Panel ID="PnlHidden" runat="server">
        ...
        <asp:HiddenField ID="hdnQ3Id" runat="server" Value="13" />
        <asp:HiddenField ID="hdnQ4Id" runat="server" Value="1018" />
        ...
        <asp:HiddenField ID="hdnQ8Id" runat="server" Value="30" />
        <asp:HiddenField ID="hdnQ9Id" runat="server" Value="31" />
        <asp:HiddenField ID="hdnQ10Id" runat="server" Value="1019" />
        <asp:HiddenField ID="hdnQ11Id" runat="server" Value="1020" />
         <asp:HiddenField ID="hdnQ12Id" runat="server" Value="1002" />
    </asp:Panel>
</asp:Content>
