     ...
     <table width="100%" cellpadding="5" cellspacing="0">
        ...
        <tr>
          <td colspan="2"><asp:Label ID="Label1" CssClass="infotext3" runat="server">
                <p style="text-align:justify">
                 <b>The Camp Livingston One Happy Camper Program, sponsored by Camp Livingston and the Foundation for Jewish Camp provides financial incentives of $1,000 to campers who attend camp for at least 19 consecutive days for the first time. Eligible campers must be entering grades 3-12 (after camp) and already signed up for Session 1, Session 2, Adventures Unlimited, Hadracha or Yisrael programs (mini-sessions are not eligible). 
                </b> </p>
            </asp:Label></td>
        </tr>
        ...
        <tr>
         ...
         <tr>
          <td colspan="2"><asp:Label ID="Label5" CssClass="infotext3" runat="server">
                <p style="text-align:justify">
                 <font style="color:Red">If the camper currently attends Jewish day school, please do not proceed with this application and instead, please call Ben Davis at Camp Livingston at 513-793-5554. 
                 </font></p>
            </asp:Label></td>
        </tr>
        <tr>
