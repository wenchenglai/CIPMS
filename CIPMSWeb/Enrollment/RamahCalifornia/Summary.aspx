...
<asp:Content ID="Ramah_Summary" ContentPlaceHolderID="Content" runat="Server">
    <table id="tblRegular" runat="server" width="100%" cellpadding="5" cellspacing="0" class="infotext3" style="text-align:justify">
        ...
        <tr>          
			<td colspan="2">
			    <p>
                    Ramah is the camping arm of Conservative Judaism. With nine overnight camps, four day camps, and Ramah Programs in Israel, 
                    ...
                    Combining a love for camping with meaningful Jewish experiences, Ramah instills in its campers and staff a love of Judaism, the Jewish people, 
                    Israel and the outdoors. The Ramah Camping Movement is guided by seven core values: self-esteem of every individual; character development; 
                    Jewish learning; Jewish identity and community; Jewish observance; Zionism; and Hebrew. 
			    </p>
                <p>
				...
				<p>
                    ...
                    <a href="http://www.campramah.org" target="_blank">www.campramah.org</a> or <a href="http://ramah.org" target="_blank">ramah.org/</a>. 
				</p>
                <p>
