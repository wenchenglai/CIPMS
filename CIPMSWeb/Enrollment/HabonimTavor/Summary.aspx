...
<asp:Content ID="National_summary" ContentPlaceHolderID="Content" runat="Server">
    <table id="tblRegular" runat="server" width="100%" cellpadding="5" cellspacing="0" class="infotext3" style="text-align:justify">
        ...
        <tr>
			<td colspan="2">
				<p>
                    The Habonim Dror One Happy Camper Program, is sponsored by Habonim Dror Camp Tavor, and provides grants of up to a $1,000 to first-time campers attending Tavor in the summer of 2017.                     
                ...
                <p>
                    ...
                    Habonim Dror campers come from all streams of the Jewish community - Conservative, Reform, Reconstructionist, Jewish Renewal, secular, Chabad, modern Orthodox and unaffiliated.                 </p>     
                <p>
                    For more information, please visit our <a href="http://camptavor.org" target="_blank">website</a> or give us a call (269-215-1399).                  
                </p>                                                              
                <p>
