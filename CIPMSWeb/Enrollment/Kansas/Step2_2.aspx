...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" runat="Server">
            ...
            <tr>
                <td>
                    <asp:CustomValidator ValidationGroup="OtherValidation" ID="CusVal" CssClass="InfoText"
                        runat="server" Display="Dynamic" ClientValidationFunction="ValidatePage2Step2_Kansas"></asp:CustomValidator>
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            ...
            <tr>
                <td valign="top" width="5%">
                    <asp:Label ID="lblAsteriskForQ6" Text="*" runat="server" CssClass="InfoText" /><asp:Label
                        ID="lblNumberForQ6" runat="server" Text="5" CssClass="QuestionText"></asp:Label></td>
    ...
    <asp:HiddenField ID="hdnQIsFirstTimeCamper" runat="server" Value="3" />
    ...
    <asp:HiddenField ID="hdnQ5Id" runat="server" Value="31" />
     <asp:HiddenField ID="hdnQSynagogueName" runat="server" Value="1002" />
</asp:Content>
