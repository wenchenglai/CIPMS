...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" runat="Server">
    ...
    <table width="100%" cellpadding="5" cellspacing="0" border="0">
        <tbody class="QuestionText">
            ...
            <tr>
                ...
                <td valign="top">
                    <asp:Panel ID="Panel1" runat="server">
                        Has the camper ever previously attended Jewish day camp?
                        <div>
                            <asp:RadioButton ID="rboYesDayCamp" value="1" runat="server" GroupName="daycamp" Text="Yes" CssClass="QuestionText" onclick="PageValidator.OnDayCampChange(this);" />
                            <asp:RadioButton ID="rboNoDayCamp" value="2" GroupName="daycamp" runat="server" Text="No" CssClass="QuestionText" onclick="PageValidator.OnDayCampChange(this);" />                            
                        </div>
                    </asp:Panel>
                </td>
            </tr>
            <tr>
                <td valign="top">
                    <asp:Label ID="lblDayCampQuestion" runat="server" Text="" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
                    <asp:Label ID="lblDayCamp" CssClass="QuestionText" runat="server" Enabled="false">Please enter the name of the day camp: </asp:Label><br />
