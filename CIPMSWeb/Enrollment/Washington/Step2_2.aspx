<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="Step2_2.aspx.cs" Inherits="Step2_Washington_2" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <table width="50%" cellpadding="0" cellspacing="0" align="center">
            <tr>
                <td>
                    <asp:CustomValidator ValidationGroup="OtherValidation" ID="CusVal" CssClass="InfoText" runat="server" Display="Dynamic"  ClientValidationFunction="ValidatePage2Step2_Washington"></asp:CustomValidator>
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            <tr>
                <td valign="top"><asp:Label ID="Label13" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label4" runat="server" Text="1" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>            
                <td valign="top"><asp:Label ID="Label24" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label9" runat="server" Text="3" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td valign="top"><asp:Label ID="Label25" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label11" runat="server" Text="4" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td width="5%"><asp:Label ID="Label26" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label15" runat="server" Text="5" CssClass="QuestionText"></asp:Label></td>
            ...
            <tr>
                    <td valign="top"><asp:Label ID="lblCamperDay" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="lblQuestion" runat="server" Text="6" CssClass="QuestionText"></asp:Label></td>
                    <td valign="top">
                    <asp:Panel id="Panel1" runat="server" >
                        <asp:Label ID="lblQuestionCamp" runat="server" CssClass="QuestionText">Has the camper ever previously attended Jewish day camp? </asp:Label><br />
                        <asp:RadioButtonList ID="RadioBtnQ12" runat="server" CssClass="QuestionText" RepeatDirection="Horizontal" OnSelectedIndexChanged="RadioBtnQ10_SelectedIndexChanged" AutoPostBack="true">
                            <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                            <asp:ListItem Text="No" Value="2"></asp:ListItem>
                        </asp:RadioButtonList> 
                    </asp:Panel>                     
                ...
                <tr>
                    <td valign="top"><asp:Label ID="lblDayCampQuestion" runat="server" Text="" CssClass="QuestionText"></asp:Label></td>
                    <td valign="top"><asp:Label ID="lblDayCamp" CssClass="QuestionText" runat="server" Enabled="false">Please enter the name of the day camp: </asp:Label><br />
                    <asp:TextBox ID="txtDayCamp" runat="server" CssClass="txtbox" Enabled="false" MaxLength="200"></asp:TextBox>
                    </td>                    
                </tr>
            <!-- Admin Panel-->
            <tr>
    ...
    <asp:Panel ID="PnlHidden" runat="server">
        ...
        <asp:HiddenField ID="hdnQ12Id" runat="server" Value="1016" />
        <asp:HiddenField ID="hdnQ13Id" runat="server" Value="1017" />
