<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="Step2_3.aspx.cs" Inherits="Step2_JCC_3" Title="Camper Enrollment Step 2" %>
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
				...
				<td colspan="3">
					<asp:Label ID="lblEligibility" runat="server" CssClass="InfoText2">
                        <p style="text-align:justify"><b>
                           Based on your responses thus far, you appear to be eligible for this program’s grant! All we need now is the camp and session information to confirm the 
                           camper is attending a camp that is eligible for this program.</b></p>
                    </asp:Label>
				</td>
			</tr>
            <tr>
                <td valign="top">
                    <asp:Label ID="Label6" Text="*" runat="server" CssClass="InfoText" />
                    <asp:Label ID="Label14" runat="server" Text="5" CssClass="QuestionText"></asp:Label></td>
                <td valign="top" colspan="2">
                    <asp:Label ID="Label15" runat="server" CssClass="QuestionText">Has the camper registered for Camp Daisy and Harry Stein yet?</asp:Label><br />
                    <asp:Label ID="Label24" runat="server" CssClass="QuestionText">
                        <p style="text-align:justify">
                             ...
                             If you have not done so, please contact the camp of your choice to register for camp.  For further assistance, 
                             please contact your local program administrator listed at the bottom of this page.  
                             Need help finding a <a href="http://www.JewishCamp.org/camps" id="A2" runat="server" target="_blank">camp</a>?
                        </p>
                    </asp:Label>                      
            ...
            <tr>
                <td valign="top">
                    ...
                    <asp:Label ID="Label18" runat="server" Text="6" CssClass="QuestionText"></asp:Label>
                </td>
                <td valign="top" colspan="2">
