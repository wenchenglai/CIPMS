        ...
        <asp:Label ID="lblEligibility" runat="server" CssClass="InfoText2">
            ...
            <tr>
                ...
                <td valign="top" colspan="2">
                    <asp:Label ID="Label15" runat="server" CssClass="QuestionText">Has the camper registered for Camp Hatikvah yet?</asp:Label><br />
            ...
            <tr>
                ...
                <td valign="top"  colspan="2">
                    <asp:Panel ID="PnlQ10" runat="server" Width="100%">
                        <div id="daysNote" runat="server"><asp:Label ID="lbl" runat="server" CssClass="QuestionText"><font color="red"><b>In order to be eligible for the incentive grant, camper must attend camp for at least 12 consecutive days.</b></font></asp:Label><br /></div>
