...
<asp:Content ID="Pittsburgh_summary" ContentPlaceHolderID="Content" Runat="Server">
    <table width="100%" cellpadding="5" cellspacing="0">
        <tr>
            <td>
	            <img id="Img2" src="../../images/AtlanticJewishCouncil.jpg" alt=""  />
                <img id="Img1" src="../../images/Montreal_GEN_J.jpg" alt="" />
            </td>
            <td>
        ...
        <tr>
			<td colspan="2">
				<asp:Label ID="Label2" CssClass="infotext3" runat="server">
					<p style="text-align:justify">
					Atlantic Canada One Happy Camper grants are awarded to first-time campers who attend a nonprofit Jewish overnight 
					summer camp for at least 19 consecutive days. Eligible campers must be entering grades 1-12 (after camp) and be attending one of the 150+ non-profit, 
					Jewish, overnight summer camp listed on the Foundation for Jewish Camp’s website 
					(<a href="http://www.OneHappyCamper.org/FindaCamp" target="_blank">www.OneHappyCamper.org/FindaCamp</a>)
					</p>
					<p style="text-align:justify">
					Included in this list 
					is the only Jewish summer camp in Atlantic Canada as well as our community camp, 
					Camp Kadimah (<a href="http://www.campkadimah.com" target="_blank">www.campkadimah.com</a>).  Camp Kadimah 
					has different session options that meet the requirements of the One Happy Camper Program.
					</p>            
				</asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <asp:Label ID="lblAdditionalInfo" runat="server" CssClass="QuestionText">
                    <p style="text-align:justify">If you need additional assistance, 
                    please call your community professional listed at the bottom of this page.</p>
                </asp:Label>
            </td>
        </tr>
    </table>
