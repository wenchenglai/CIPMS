<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="Step2_3.aspx.cs" Inherits="Step2_Calgary_3" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server" width="100%">
        ...
        <asp:Label ID="lblEligibility" runat="server" CssClass="InfoText2">
            ...
            <tr>
                <td colspan="3">
                <p class="QuestionText" style="color:Red;">Please note: This application will only allow you to select Jewish overnight camps in Canada. If you would like to select a camp in the United States, please save and exit this application and contact Judy Shapiro at 403-444-3153.</p>
                </td>
            </tr>
            <tr>
                <td valign="top">
            ...
            <tr>
                <td colspan="3">
                        <asp:CustomValidator ID="CustomValidator1" CssClass="InfoText" Font-Size="15px" runat="server" ClientValidationFunction="ValidateStep4" Display="Dynamic" OnServerValidate="ValidateDataInput" />
                        <!--this summary will be used only for Comments field (only for Admin user)-->
                        <asp:ValidationSummary ID="ValidationSummary1" ValidationGroup="CommentsGroup" runat="server" ShowSummary="true" CssClass="InfoText" />
                        <!--to vaidate the comments text box for admin user-->
                        <asp:CustomValidator ID="CustomValidator2" runat="server" CssClass="InfoText" ErrorMessage = "<li>Please enter the Comments</li>" EnableClientScript="false" />
