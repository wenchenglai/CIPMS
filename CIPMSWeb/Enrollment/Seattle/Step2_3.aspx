            ...
            <tr>
                ...
                <td valign="top"  colspan="2">
                    <asp:Panel ID="PnlQ10" runat="server" Width="100%">
                        <asp:Label ID="lbl" runat="server" CssClass="QuestionText"><font color="red"><b>In order to be eligible for the Seattle OHC incentive grant, the camper must attend camp for at least 19 consecutive days (unless attending camp in the west; s/he must attend for at least 12 consecutive days).</b></font></asp:Label><br />
