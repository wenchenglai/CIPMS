        ...
        <tr>
          <td colspan="2"><asp:Label ID="Label1" CssClass="infotext3" runat="server">
                <p style="text-align:justify"><b>
                  The Camp Avoda One Happy Camper program, sponsored by Camp Avoda and the Foundation for Jewish Camp provides financial incentives of $1,000 to first-time campers who attend Camp Avoda for at least 19 consecutive days. Eligible campers must be entering grades 2-10 (after camp) and not currently attend Jewish day school.
                 </b></p>
            </asp:Label></td>
        </tr>
                <tr>
