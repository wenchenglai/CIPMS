        ...
        <tbody class="QuestionText">
            ...
            <tr id="1a">
                ...
                <div id="divGrandfatherRule" runat="server">
                    <asp:RadioButton ID="rdoDays12" value="1" GroupName="radiodays" runat="server" Text="12-18 days" />
                    <asp:RadioButton ID="rdoDays19" value="2" GroupName="radiodays" runat="server" Text="19+ days" />
                </div>
                </td>
            </tr>
            <tr>
