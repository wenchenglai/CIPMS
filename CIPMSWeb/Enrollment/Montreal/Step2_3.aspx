...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server" width="100%">
        ...
        <asp:Label ID="lblEligibility" runat="server" CssClass="InfoText2">
            ...
            <%--<tr>
                <td colspan="3">
                <p class="QuestionText" style="color:Red;">Please note: This application will only allow you to select Jewish overnight camps in Canada. If you would like to select a camp in the United States, please save and exit this application and contact Agata Kesik-Libin at 403-537-8592</p>
                </td>
            </tr>--%>
            <tr>
                <td valign="top">
