<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="Step2_2.aspx.cs" Inherits="Step2_Cincinnati_2" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            <tr>
                ...
                <td valign="top">
                    <asp:Label ID="Label5" runat="server" CssClass="QuestionText">Will this be the camper’s first time attending a nonprofit Jewish overnight summer camp for any length of time?</asp:Label><br />
    ...
    <asp:HiddenField ID="hdnQ3Id" runat="server" Value="34" />
