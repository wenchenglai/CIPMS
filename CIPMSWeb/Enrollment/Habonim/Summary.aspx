			...
			<td colspan="2">
				<asp:Label ID="Label1" runat="server" CssClass="infotext3">
					<p style="text-align:justify">
						...
						Campers who attend our western camps, Camp Gilboa (CA) or Camp Miriam (BC), are eligible for a $700 grant if they attend camp for 12-18 consecutive days. 
						Eligible campers must be entering grades 3-10 (after camp) and attending one of our 7 camps in the summer of 2013, including:</b>
					</p>
				</asp:Label>
			</td> 
        </tr>                   
        <tr>
            <td colspan="2">
                <asp:Label ID="Label2" runat="server" CssClass="infotext3">
                    <p style="text-align:justify">
						<ul>
							<li>Greater Philadelphia Tri-State area - <a href="http://www.campgalil.org" target="_blank">Habonim Dror Camp Galil</a></li>
