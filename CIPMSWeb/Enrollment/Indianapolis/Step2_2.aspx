...
<asp:Content ID="ContentStep2_Indianapolis_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <table width="50%" cellpadding="0" cellspacing="0" align="center">
            <tr>
                <td>
                    <asp:CustomValidator ValidationGroup="OtherValidation" ID="CusVal" CssClass="InfoText" runat="server" Display="Dynamic"  ClientValidationFunction="ValidatePage2Step2_IndianaPollis"></asp:CustomValidator>
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            ...
            <tr>
                <td valign="top"><asp:Label ID="Label3" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label6" runat="server" Text="2" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td valign="top"><asp:Label ID="Label7" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label35" runat="server" Text="3" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
                    <asp:Panel ID="PnlQ5" runat="server">
                        <asp:Label ID="Label8" runat="server" CssClass="QuestionText">Did the camper receive an incentive grant through the Jewish Federation of Greater Indianapolis’ Camper Incentive Program last summer?</asp:Label><br />
            ...
            <tr>
                <td valign="top"><asp:Label ID="Label12" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label9" runat="server" Text="5" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td valign="top"><asp:Label ID="Label19" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label11" runat="server" Text="6" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
                    <asp:Label ID="Label13" runat="server" CssClass="QuestionText">What kind of school does the camper <u><b>CURRENTLY</b></u> attend?</asp:Label><br />
                    <asp:RadioButtonList AutoPostBack="true" CssClass="QuestionText" 
                        ID="RadioBtnQ9" runat="server" RepeatDirection="Horizontal" 
                        onselectedindexchanged="RadioBtnQ9_SelectedIndexChanged">
             ...
             <tr>
                <td width="5%">
                    <asp:Panel ID="PnlSchoollbl" runat="server">
                        <asp:Label ID="Label25" Text="*" runat="server" CssClass="InfoText" />
                        <asp:Label ID="Label15" runat="server" Text="7" CssClass="QuestionText"></asp:Label>
                    </asp:Panel>
                </td>
                <td valign="top" colspan="2">
                    <asp:Panel ID="pnlCamperSchool" runat="server">
                        ...
                        <asp:TextBox ID="txtCamperSchool" runat="server" CssClass="txtbox" MaxLength="200" CausesValidation="false"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="reqvalSchool"  Display="none" ControlToValidate="txtCamperSchool" runat="server" ErrorMessage=""></asp:RequiredFieldValidator>
                    </asp:Panel>
                </td>
            </tr>
            ...
            <!--end of admin panel-->
            <tr >
                <td valign="top"><asp:Label ID="Label24" runat="server" Text="" CssClass="QuestionText"></asp:Label></td>
                <td valign="top"  colspan="2">
