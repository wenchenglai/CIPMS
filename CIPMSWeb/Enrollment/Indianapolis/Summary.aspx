    ...
    <table id="tblRegular" runat="server" width="100%" cellpadding="5" cellspacing="0" class="infotext3" style="text-align:justify">
        ...
        <tr>
			<td colspan="2">
                ...
                <p>
                    <span style="color:red; font-weight:bold">Attention Jewish day school families</span>:  If the camper currently attends Jewish day school, please do not proceed with this application and instead, please call Inna Kolesnikova-Shmukler at 317-715-9264.
                </p>  
                <p>
            ...
            <td>
                <asp:Label ID="Label9" runat="server" CssClass="infotext3">
                    <p style="text-align:justify">
						The Jewish Federation of Greater Indianapolis  One Happy Camper program is now closed for the summer of 2015. For more information, please contact the professional listed at the bottom of the screen.
                    </p>
                </asp:Label>
			</td>
        </tr>
