<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="Step2_3.aspx.cs" Inherits="Step2_Judaea_3" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server" width="100%">
        ...
        <asp:Label ID="lblEligibility" runat="server" CssClass="InfoText2">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label7" Text="*" runat="server" CssClass="InfoText" Enabled="false" /><asp:Label ID="Label18" runat="server" Text="6" CssClass="QuestionText" Enabled="False"></asp:Label></td>
                <td valign="top" colspan="2">
            ...
            <tr>
                <td valign="top"><asp:Label ID="lblQ9star" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="lbQ9" runat="server" Text="7" CssClass="QuestionText"></asp:Label></td>
                <td valign="top"  colspan="2">
            ...
            <tr>
                ...
                <td valign="top"  colspan="2">
                    <asp:Panel ID="PnlQ10" runat="server" Width="100%">
                        <asp:Label ID="lbl" runat="server" CssClass="QuestionText"><font color="red"><b>In order to be eligible for the incentive grant, camper must attend camp for at least 19 consecutive days.</b></font></asp:Label><br />
