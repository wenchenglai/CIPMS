...
<asp:Content ID="National_summary" ContentPlaceHolderID="Content" runat="Server">
    <table id="tblRegular" runat="server" width="100%" cellpadding="5" cellspacing="0" class="infotext3" style="text-align:justify">
        ...
        <tr>
			<td colspan="2">
				<p>
The Habonim Dror One Happy Camper Program, sponsored by the Habonim Dror Camp Association and the Foundation for Jewish Camp, provides grants of up to a $1,000 to first-time campers of Habonim Dror Camp Galil in the summer of 2016. 
