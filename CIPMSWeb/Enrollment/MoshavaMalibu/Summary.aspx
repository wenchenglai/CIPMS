			...
			<td colspan="2">
				<asp:Label ID="Label2" CssClass="infotext3" runat="server">
					<p style="text-align:justify">
						...
						who have never attended a non-profit Jewish overnight camp for 12 days or longer. This incentive cannot be combined with other discounts 
                        or promotions offered by Moshava Malibu.  It is only available to children who do not attend Jewish day school.  These funds are limited 
                        and may run out at any time without notice.
					</p>
				</asp:Label>
			</td>
        </tr>      
