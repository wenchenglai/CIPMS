<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true"
    CodeFile="Step2_2.aspx.cs" Inherits="Step2_JCC_2" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" runat="Server">
            ...
            <tr>
                <td>
                    <asp:CustomValidator ValidationGroup="OtherValidation" ID="CusVal" CssClass="InfoText"
                        runat="server" Display="Dynamic" ClientValidationFunction="ValidatePage2Step2_MountainChai"></asp:CustomValidator>
            ...
            <tr>
                ...
                <td valign="top">
                    <asp:Panel ID="PnlQ2" runat="server">
                        <asp:Label ID="Label5" runat="server" CssClass="QuestionText">Will this be the camper's first time attending a nonprofit Jewish overnight summer camp for 12 consecutive days or longer? (If you have only attended winter camp and/or family camp in the past, you should answer yes).</asp:Label><br />
    ...
    <asp:HiddenField ID="hdnQ4Id" runat="server" Value="40" />
