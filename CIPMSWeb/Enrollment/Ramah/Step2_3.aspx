            ...
            <tr>
                ...
                <td valign="top"  colspan="2">
                    <asp:Panel ID="PnlQ10" runat="server" Width="100%">
                       <font color="red"><b> <asp:Label ID="lbl" runat="server" CssClass="QuestionText">In order to be eligible for an incentive grant, the camper must attend camp for at least</asp:Label> <asp:Label ID="lblMinimunDays" runat="server" Text="19" CssClass="QuestionText"></asp:Label> <asp:Label ID="Label11" runat="server" CssClass="QuestionText"> consecutive days.</asp:Label> </b></font> <br />
