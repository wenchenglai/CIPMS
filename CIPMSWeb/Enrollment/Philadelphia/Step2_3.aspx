<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="Step2_3.aspx.cs" Inherits="Step2_NY_3" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server" width="100%">
        ...
        <asp:Label ID="lblEligibility" runat="server" CssClass="InfoText2">
            ...
            <tr>
                <td valign="top"><asp:Label ID="Label9" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label22" runat="server" Text="10" CssClass="QuestionText"></asp:Label></td>
                <td valign="top"  colspan="2">
            ...
            <tr>
                ...
                <td valign="top"  colspan="2">
                    ...
                    <p class="InfoText">
					    In order to be eligible for an incentive grant, the camper must attend camp for at least 12 consecutive days. If camper attended camp in the summer of 2016 for 12-18 days as a first time camper they are ONLY eligible for the grant if attending camp for 19 or more consecutive days in summer 2017.
                    </p>
