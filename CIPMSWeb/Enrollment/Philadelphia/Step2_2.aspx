...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <table width="50%" cellpadding="0" cellspacing="0" align="center">
            <tr>
                <td>
                    <asp:CustomValidator ValidationGroup="OtherValidation" ID="CusVal" CssClass="InfoText" runat="server" Display="Dynamic"  ClientValidationFunction="ValidatePage2Step2_Philadelphia"></asp:CustomValidator>
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            ...
            <tr>
                <td valign="top"><asp:Label ID="Label17" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label6" runat="server" Text="2" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>            
                <td valign="top"><asp:Label ID="Label24" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label9" runat="server" Text="5" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td valign="top"><asp:Label ID="Label25" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label11" runat="server" Text="6" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
            ...
            <tr>
                <td width="5%"><asp:Label ID="Label26" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label15" runat="server" Text="7" CssClass="QuestionText"></asp:Label></td>
