<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true"
    CodeFile="Step2_2.aspx.cs" Inherits="Step2_Columbus_2" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
            ...
            <tr>
                <td>
                    <asp:CustomValidator ValidationGroup="OtherValidation" ID="CusVal" CssClass="InfoText"
                        runat="server" Display="Dynamic" ClientValidationFunction="ValidatePage2Step2_Arkansas"></asp:CustomValidator>
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            <tr>
                ...
                <td valign="top">
                    <asp:Panel ID="pnlQ2" runat="server">
                        ...
                        <asp:RadioButtonList ID="rbtnListQ2" runat="server" AutoPostBack="true"  CssClass="QuestionText" RepeatDirection="Horizontal">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label6" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label7"
                        runat="server" Text="2" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
                    <asp:Panel ID="pnlQ3" runat="server">
                        <asp:Label ID="lblQ4" runat="server" CssClass="QuestionText">Will this be the camper’s second time attending Jewish overnight camp for 19 days or longer?</asp:Label><br />
                        <asp:RadioButtonList ID="rbtnListQ3" runat="server" AutoPostBack="true"  CssClass="QuestionText" RepeatDirection="Horizontal">
                            <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                            <asp:ListItem Text="No" Value="2"></asp:ListItem>
                        </asp:RadioButtonList>
                    </asp:Panel>
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label13" Text="*" runat="server" CssClass="InfoText" /><asp:Label
                        ID="Label14" runat="server" Text="3" CssClass="QuestionText"></asp:Label></td>
                <td valign="top">
                    <asp:Panel ID="pnlQ4" runat="server">
                        <asp:Label ID="Label17" runat="server" CssClass="QuestionText">Did the camper receive an incentive grant through the Jewish Federation of Arkansas last summer?</asp:Label><br />
                        <asp:RadioButtonList ID="rbtnListQ4" runat="server" CssClass="QuestionText" RepeatDirection="Horizontal">
                            <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                            <asp:ListItem Text="No" Value="2"></asp:ListItem>
                        </asp:RadioButtonList>
                    </asp:Panel>
            ...
            <tr>
                ...
                <td valign="top">
                    <asp:Panel ID="divQ5" runat="server">
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <asp:RequiredFieldValidator ID="reqval" ControlToValidate="RadioButtonQ6" runat="server"
                        Display="none" ErrorMessage="Please select the type of School"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td valign="top" width="5%">
                    <asp:Label ID="lblAsteriskForQ7" Text="*" runat="server" CssClass="InfoText" /><asp:Label
                        ID="lblNumberForQ7" runat="server" Text="6" CssClass="QuestionText"></asp:Label></td>
    ...
    <asp:HiddenField ID="hdnQ13Id" runat="server" Value="13" />
    <asp:HiddenField ID="hdnQ29Id" runat="server" Value="29" />
