<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="Step2_2.aspx.cs" Inherits="Step2_Memphis_2" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server">
        ...
        <table width="50%" cellpadding="0" cellspacing="0" align="center" border="0">
            <tr>
                <td>
                    <asp:CustomValidator ValidationGroup="OtherValidation" ID="CusVal" CssClass="InfoText" runat="server" Display="Dynamic" ClientValidationFunction="ValidatePage2Step2_Memphis"></asp:CustomValidator>
            ...
            <tr>
                ...
                <td valign="top">
                    <asp:Panel ID="PnlQ5" runat="server">
                        <asp:Label ID="Label14" runat="server" CssClass="QuestionText">Did the camper receive an incentive grant through the Jewish Foundation of Memphis last summer? </asp:Label><br />
   ...
   <%-- <asp:HiddenField ID="hdnQ25Id" runat="server" Value="25" />--%>
   <asp:HiddenField ID="hdnQ25Id" runat="server" Value="30" />
    <asp:HiddenField ID="hdnQ26Id" runat="server" Value="31" />
     <asp:HiddenField ID="hdnQ8Id" runat="server" Value="28" />
    <asp:HiddenField ID="hdnQ9Id" runat="server" Value="29" />
