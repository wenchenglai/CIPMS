...
<asp:Content ID="ContentStep2_CN_1" ContentPlaceHolderID="Content" Runat="Server">
    <asp:Panel ID="Panel2" runat="server" width="100%">
        ...
        <table>
                ...
                <td colspan="3">
                    <asp:Label ID="lblEligibility" runat="server" CssClass="InfoText2">
                        <p style="text-align:justify">
                            <b>Based on your responses thus far, you appear to be eligible for this program's grant! 
                           All we need now is the camp and session information to confirm the camper is attending a camp that is eligible for this program.</b>
                        </p>
                    </asp:Label>
                </td>
        </tr>
            <tr>
                <td>
                    <asp:Label ID="Label6" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label14" runat="server" Text="10" CssClass="QuestionText"></asp:Label></td>
                <td colspan="2">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label7" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label18" runat="server" Text="11" CssClass="QuestionText"></asp:Label></td>
            ...
            <tr>
                ...
                <td>
                    <asp:Panel ID="PnlQ8_2_2" Enabled="true" runat="server" width="100%">
                        <asp:DropDownList ID="ddlCamp"  Enabled="true" runat="server" CssClass="dropdown">
                        </asp:DropDownList>
                    </asp:Panel>
                </td>
            </tr>
            <tr>
                <td valign="top"><asp:Label ID="Label9" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label22" runat="server" Text="12" CssClass="QuestionText"></asp:Label></td>
                <td valign="top"  colspan="2">
                    <asp:Panel ID="PnlQ9" runat="server" width="100%">
                        ...
                        <asp:TextBox id="txtCampSession" runat="server" CssClass="txtbox1"></asp:TextBox>
                    </asp:Panel>
                </td>
            </tr>
            <tr>
                <td valign="top">
                    <asp:Label ID="Label8" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label25" runat="server" Text="13" CssClass="QuestionText"></asp:Label></td>
                <td valign="top"  colspan="2">
                    <asp:Panel ID="PnlQ10" runat="server" Width="100%">
                        <asp:Label ID="lbl" runat="server" CssClass="QuestionText">
							<font color="red">
								<b> In order to be eligible for the SF OHC incentive grant, the camper must attend camp for at least 19 consecutive days 
