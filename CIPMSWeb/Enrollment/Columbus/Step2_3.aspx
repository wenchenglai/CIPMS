                    ...
                    <asp:Panel ID="PnlQ10" runat="server" Width="100%">
                        <asp:Label ID="lbl" runat="server" CssClass="QuestionText">
                            <span style="color:red; font-weight: bold;">
                                ...
                                If camper attended camp in the summer of 2014 for 12-18 days as a first time camper s/he is ONLY eligible 
                                for the grant if attending camp for 19 or more consecutive days in summer 2015.
                            </span>
                        </asp:Label>
                        <br />
