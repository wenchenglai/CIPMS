<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Common.master" AutoEventWireup="true" CodeFile="Step2_3.aspx.cs" Inherits="Step2_Chicago_3" Title="Camper Enrollment Step 2" %>
...
<asp:Content ID="ContentStep2_Chicago_1" ContentPlaceHolderID="Content" runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server" Width="100%">
        ...
        <table width="100%" cellpadding="5" cellspacing="0" border="0">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label6" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label14" runat="server" Text="8" CssClass="QuestionText"></asp:Label></td>
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label7" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label18" runat="server" Text="9" CssClass="QuestionText"></asp:Label></td>
                <td valign="top" colspan="2">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label9" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label22" runat="server" Text="10" CssClass="QuestionText"></asp:Label></td>
                <td valign="top" colspan="2">
            ...
            <tr>
                <td valign="top">
                    <asp:Label ID="Label8" Text="*" runat="server" CssClass="InfoText" /><asp:Label ID="Label25" runat="server" Text="11" CssClass="QuestionText"></asp:Label></td>
                <td valign="top" colspan="2">
                    <asp:Panel ID="PnlQ10" runat="server" Width="100%">
                        <asp:Label ID="lbl" runat="server" CssClass="QuestionText"><font color="red"><b>In order to be eligible for an incentive grant, the camper must attend camp for at least 19 consecutive days. (Some exceptions apply).</b></font></asp:Label><br />
