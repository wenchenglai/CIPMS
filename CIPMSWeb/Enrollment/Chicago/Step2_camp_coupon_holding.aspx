...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" Runat="Server">
    <div class="QuestionText">
        <p>
            It appears that you are not eligible for the One Happy Camper first time incentive grant. However you may be eligible for a Camp Coupon, a program of the Jewish United Fund of Chicago and administered through the One Happy Camper registration system.
        </p>
        <p>
            The Camp Coupon program application will launch in December 2014.
        </p>
        <p>
