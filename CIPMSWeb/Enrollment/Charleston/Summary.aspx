    ...
    <table id="tblRegular" runat="server" width="100%" cellpadding="5" cellspacing="0" class="infotext3" style="text-align:justify">
        ...
        <tr>
			<td colspan="2">
			    ...
			    <p>
                    The Low country One Happy Camper Grant program, sponsored by the Charleston Jewish Federation and the Foundation for Jewish Camp, offers incentive grants of up to $1,000 to first-time campers.
			    </p>
