    ...
    if ($chkSynagogue.length) {
        ...
        if ($chkSynagogue.is(':checked') && !$chkSynagogue.is(':disabled')) {
            if ($('#ctl00_Content_ddlSynagogue>option:selected').val() === "0") {
                errorMsg.innerHTML += "<ul><li>Error - please select one synagogue.</li></ul>";
            }
            ...
            if ($('#ctl00_Content_ddlSynagogue>option:selected').text().toLowerCase() === "other (please specify)") {
                if ($('#ctl00_Content_txtOtherSynagogue').val() === "") {
                    errorMsg.innerHTML += "<ul><li>Error - please enter the synagogue name.</li></ul>";
                }
            }
        }
        ...
        if ($chkJCC.is(':checked') && !$chkJCC.is(':disabled')) {
            if ($('#ctl00_Content_ddlJCC>option:selected').val() === "0") {
                errorMsg.innerHTML += "<ul><li>Error - please select one JCC.</li></ul>";
            }

            if ($('#ctl00_Content_ddlJCC>option:selected').text().toLowerCase() === "other (please specify)") {
                if ($('#ctl00_Content_txtJCC').val() === "") {
                    errorMsg.innerHTML += "<ul><li>Error - please enter the JCC name.</li></ul>";
                }
            }
        }
    }
...
function ValidatePage2Step2_RhodeIsland(sender,args)
{
    ...
    //validate Q4
        ...
        else if (Q5CheckedValue != "3" && trim(Q6.value) == "") {
            valobj.innerHTML = "<ul><li>Please enter Name of the School</li></ul>";
            bValid = false;
        }
    }
...
function ValidatePage2Step2_LACIP(sender,args)
{
    var inputobjs = document.getElementsByTagName("input");
    var selectobjs = document.getElementsByTagName("select");
    var Q3_1, Q3_2, QSchoolType_0, QSchoolType_1, QSchoolType_2, QSchoolType_3, QSchoolName, QGrade;
    ...
    for (var i = 0; i< inputobjs.length-1; i++)
    {
        ...
        if (inputobjs[i].id.indexOf("RadioBtnQ2_0")>=0)
            QSchoolType_0 = inputobjs[i];
        
        if (inputobjs[i].id.indexOf("RadioBtnQ2_1")>=0)
            QSchoolType_1 = inputobjs[i];
        
        if (inputobjs[i].id.indexOf("RadioBtnQ2_2")>=0)
            QSchoolType_2 = inputobjs[i];
        
        if (inputobjs[i].id.indexOf("RadioBtnQ2_3")>=0)
            QSchoolType_3 = inputobjs[i];
            
        if (inputobjs[i].id.indexOf("txtCamperSchoolOthers") >= 0)
    ...
    if (QSchoolType_0.checked == false && QSchoolType_1.checked == false && QSchoolType_2.checked == false && QSchoolType_3.checked == false) {
        valobj.innerHTML = "<ul><li>Please answer Question No. 3</li></ul>";
        args.IsValid = false;
        return;
    }
